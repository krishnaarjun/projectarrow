...
namespace TouchInputManagerBackendEditor
{
    public class TouchInputManagerEditorBase : EditorWindow {
        ...
        { 
            ...
            _touchInputManagerLogo = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/TouchInputManagerLogo.png", typeof(Texture)) as Texture;
            _touchInputManagerLogoSmallFaded = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/TouchInputManagerLogoSmallFaded.png", typeof(Texture)) as Texture;
            _lightWithBorderBG = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/lightWithBorder.png", typeof(Texture2D)) as Texture2D;
            _lightNoBorderBG = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/lightNoBorder.png", typeof(Texture2D)) as Texture2D;
            _lightDottedBorderBG = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/lightDottedBorder.png", typeof(Texture2D)) as Texture2D;
            _darkWithBorderBG = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/darkWithBorder.png", typeof(Texture2D)) as Texture2D;
            _darkNoBorderBG = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/darkNoBorder.png", typeof(Texture2D)) as Texture2D;
            _selectedBG = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/selectedNoBorder.png", typeof(Texture2D)) as Texture2D;
            _selectedOldBG = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/selectedOldNoBorder.png", typeof(Texture2D)) as Texture2D;
            _justBorderBG = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/Border.png", typeof(Texture2D)) as Texture2D;
            _jusRightBorderBG = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/BorderRight.png", typeof(Texture2D)) as Texture2D;
            _allLayoutsIcon = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/allLayoutsIcon.png", typeof(Texture)) as Texture;
            _layoutIcon = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/layoutIcon.png", typeof(Texture)) as Texture;
            _joystickIcon = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/joystickIcon.png", typeof(Texture)) as Texture;
            _buttonIcon = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/buttonIcon.png", typeof(Texture)) as Texture;
            _settingsIcon = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/settingIcon.png", typeof(Texture)) as Texture;
            _moveIcon = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/moveIcon.png", typeof(Texture)) as Texture;
            _animationIcon = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/animationIcon.png", typeof(Texture)) as Texture;
            _errorIcon = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/errorIcon.png", typeof(Texture)) as Texture;
            _noErrorIcon = AssetDatabase.LoadAssetAtPath("Assets/TouchInputManager/Images/noErrorIcon.png", typeof(Texture)) as Texture;
        }
